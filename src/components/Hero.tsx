...
const Hero = () => {
  ...
  return (
    <div className="relative min-h-[calc(100vh-80px)] w-full overflow-visible">
      ...
      <div className="absolute -bottom-[200px] left-1/2 h-[900px] w-[1400px] -translate-x-1/2 rounded-full bg-gradient-to-br from-[#e6575e]/40 via-[#f88a8f]/50 to-[#e6575e]/40 blur-3xl" />
