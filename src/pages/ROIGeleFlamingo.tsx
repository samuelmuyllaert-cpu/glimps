...
export default function ROIGeleFlamingo() {
    ...
    <div className="min-h-screen bg-[#F5F5F3]" style={{ fontFamily: "'Inter', sans-serif" }}>
        ...
        <div className="max-w-5xl mx-auto flex items-start justify-between gap-6">
          <div>
            <h1 className="text-3xl md:text-4xl font-bold text-yellow-400 leading-tight"
              style={{ fontFamily: "'DM Serif Display', serif" }}>
              ROI Analyse — AI Chatbot
            </h1>
            <p className="text-zinc-400 text-sm mt-2">
              De Gele Flamingo&nbsp;&nbsp;·&nbsp;&nbsp;Pakket Business (€525/m)&nbsp;&nbsp;·&nbsp;&nbsp;Geboortelijst-engagement
            </p>
          </div>
      ...
      <div className="max-w-5xl mx-auto px-4 py-10 space-y-8">
        ...
        <section className="rounded-2xl overflow-hidden shadow-sm border border-blue-200">
          ...
          >
            <p className="text-sm font-bold text-white">UTM-tracking — geboortelijst</p>
        ...
        <section>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="bg-white border border-zinc-200 rounded-2xl p-5 shadow-sm">
              ...
              <ul className="space-y-2">
                {[
                  ...
                  "Gorgias: vergelijk tickets voor en na go-live",
            ...
            <div className="bg-white border border-zinc-200 rounded-2xl p-5 shadow-sm">
              <p className="text-sm font-bold text-zinc-900 mb-3">Geboortelijst via bot (UTM)</p>
              <ul className="space-y-2">
                {[
                  <span key="a">Elke productlink bevat <code className="bg-zinc-100 px-1 rounded text-xs">?utm_source=chatbot&utm_medium=geboortelijst</code></span>,
            ...
            <div className="bg-white border border-zinc-200 rounded-2xl p-5 shadow-sm sm:col-span-2">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-5 gap-4">
                {[
                  ...
                  "Geboortelijst-tracking",
                  "Escalaties naar Gorgias",
        ...
        <section className="bg-zinc-900 rounded-2xl p-6">
          <p className="text-xs font-bold text-yellow-400 uppercase tracking-widest mb-3">Nota voor Sophie</p>
          <p className="text-sm text-zinc-300 leading-relaxed">
            Alle opbrengsten worden berekend op het marge-aandeel van de omzet, niet op brutoomzet. Eerst doorlopen jullie een interne demo-periode waarbij jullie team de bot intern test — pas daarna gaat de bot live op de website. De ROI-cijfers op dit model zijn schattingen gebaseerd op jullie situatie. Eens live zijn de extra omzet exact meetbaar via UTM-tags in Shopify en Google Analytics, en leveren wij maandelijks een rapport met echte cijfers.
          </p>
        </section>
