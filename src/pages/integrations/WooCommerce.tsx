...
const WooCommerceIntegration = () => {
  ...
  const enContent = {
    ...
    subtitle: "Connect Glimps to your WooCommerce store via a simple widget. Automatic synchronisation of products, stock and orders — for smart customer service 24/7.",
    ctaButton: "Request a demo",
    howTitle: "How the WooCommerce integration works",
    howSteps: [
      { step: "01", title: "Add the widget", desc: "Paste a simple snippet into your WordPress theme. No plugin, no complex installation." },
      { step: "02", title: "Automatic sync", desc: "All your products, categories, prices and stock are automatically imported via the WooCommerce REST API." },
      { step: "03", title: "AI training", desc: "The chatbot learns your products, policies and tone of voice within a few hours." },
      { step: "04", title: "Live and running", desc: "Your WooCommerce chatbot is live and answers customers 24/7." }
    ],
    benefitsTitle: "What Glimps does for your WooCommerce store",
    benefits: [
      ...
      { icon: RefreshCw, title: "Returns & exchanges", desc: "The chatbot guides customers through the return process in line with your WooCommerce policy." },
    ...
    ctaTitle: "Ready to connect Glimps to WooCommerce?",
    ctaSubtitle: "Join hundreds of WooCommerce stores using Glimps to automate their customer service and sell more.",
    seoTitle: "AI Chatbot for WooCommerce - Glimps AI | WooCommerce Integration",
    seoDescription: "Connect Glimps to your WooCommerce store via a widget. Automatic product sync and order tracking. AI customer service 24/7 for your WooCommerce store.",
  };

  const content = isFR ? {
    badge: "Intégration WooCommerce",
    title: "Chatbot IA pour",
    titleHighlight: "WooCommerce",
    subtitle: "Connectez Glimps à votre boutique WooCommerce via un simple widget. Synchronisation automatique des produits, du stock et des commandes — pour un service client intelligent 24/7.",
    ctaButton: "Demander une démo",
    howTitle: "Comment fonctionne l'intégration WooCommerce",
    howSteps: [
      { step: "01", title: "Ajoutez le widget", desc: "Collez un simple extrait de code dans votre thème WordPress. Aucun plugin, aucun code complexe." },
      { step: "02", title: "Synchronisation automatique", desc: "Tous vos produits, catégories, prix et stock sont importés automatiquement via l'API REST WooCommerce." },
      { step: "03", title: "Formation de l'IA", desc: "Le chatbot apprend vos produits, politiques et ton de voix en quelques heures." },
      { step: "04", title: "En ligne et opérationnel", desc: "Votre chatbot WooCommerce est actif et répond aux clients 24h/24, 7j/7." }
    ],
    benefitsTitle: "Ce que Glimps fait pour votre boutique WooCommerce",
    benefits: [
      ...
      { icon: RefreshCw, title: "Gestion des retours & échanges", desc: "Le chatbot guide les clients dans les procédures de retour conformément à votre politique WooCommerce." },
    ...
    useCases: [
      "\"Où est ma commande WooCommerce #12345 ?\"",
      "\"Avez-vous cette veste en taille M ?\"",
      "\"Quelle est votre politique de retour ?\"",
      "\"Recommandez-moi un cadeau pour un coureur\"",
      "\"Combien de temps prend la livraison ?\"",
      "\"Ce complément est-il sans gluten ?\"",
      "\"Puis-je encore annuler ma commande ?\"",
      "\"Y a-t-il des promotions en cours ?\""
    ],
    statsTitle: "Résultats moyens pour les boutiques WooCommerce avec Glimps",
    stats: [
    ...
    ctaTitle: "Prêt à connecter Glimps à WooCommerce ?",
    ctaSubtitle: "Rejoignez des centaines de boutiques WooCommerce qui utilisent Glimps pour automatiser leur service client et augmenter leurs ventes.",
    seoTitle: "Chatbot IA pour WooCommerce - Glimps AI | Intégration WooCommerce",
    seoDescription: "Connectez Glimps à votre boutique WooCommerce via un widget. Synchronisation automatique des produits et commandes. Service client IA 24/7.",
  } : {
    badge: "WooCommerce Integratie",
    title: "AI Chatbot voor",
    titleHighlight: "WooCommerce",
    subtitle: "Verbind Glimps met je WooCommerce webshop via een eenvoudige widget. Automatische synchronisatie van producten, voorraad en bestellingen — voor slimme klantenservice 24/7.",
    ctaButton: "Demo aanvragen",
    howTitle: "Hoe de WooCommerce integratie werkt",
    howSteps: [
      { step: "01", title: "Voeg de widget toe", desc: "Plak een eenvoudig stukje code in je WordPress thema. Geen plugin, geen complexe installatie." },
      { step: "02", title: "Automatische synchronisatie", desc: "Al je producten, categorieën, prijzen en voorraad worden automatisch ingeladen via de WooCommerce REST API." },
      { step: "03", title: "AI training", desc: "De chatbot leert je producten, beleid en tone of voice binnen enkele uren." },
      { step: "04", title: "Live en operationeel", desc: "Je WooCommerce chatbot staat live en beantwoordt klanten 24/7." }
    ],
    benefitsTitle: "Wat Glimps doet voor jouw WooCommerce webshop",
    benefits: [
      ...
      { icon: RefreshCw, title: "Retour- en ruilbeheer", desc: "De chatbot begeleidt klanten door het retourproces conform jouw WooCommerce-beleid." },
    ...
    useCases: [
      "\"Waar is mijn WooCommerce bestelling #12345?\"",
      "\"Hebben jullie dit jasje in maat M?\"",
      "\"Wat is jullie retourbeleid?\"",
      "\"Aanbeveel me een cadeau voor een hardloper\"",
      "\"Hoe lang duurt de levering?\"",
      "\"Is dit supplement glutenvrij?\"",
      "\"Kan ik mijn bestelling nog annuleren?\"",
      "\"Zijn er momenteel kortingen?\""
    ],
    statsTitle: "Gemiddelde resultaten voor WooCommerce webshops met Glimps",
    stats: [
    ...
    ctaTitle: "Klaar om Glimps aan WooCommerce te koppelen?",
    ctaSubtitle: "Sluit je aan bij honderden WooCommerce webshops die Glimps gebruiken om hun klantenservice te automatiseren en meer te verkopen.",
    seoTitle: "AI Chatbot voor WooCommerce - Glimps AI | WooCommerce Integratie",
    seoDescription: "Verbind Glimps met je WooCommerce webshop via een widget. Automatische productsync en besteltracking. AI klantenservice 24/7.",
  };
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO
        ...
        path={isFR ? "/fr/integrations/woocommerce" : isEN ? "/en/integrations/woocommerce" : "/integrations/woocommerce"}
        language={language}
      />
      <StructuredData type="organization" />
      <StructuredData type="webpage" data={{ name: activeContent.seoTitle, description: activeContent.seoDescription, url: isFR ? "https://www.glimps.be/fr/integrations/woocommerce" : isEN ? "https://www.glimps.be/en/integrations/woocommerce" : "https://www.glimps.be/integrations/woocommerce" }} />
      <Navigation />

      <section className="relative overflow-hidden px-6 py-20">
        <div className="pointer-events-none absolute bottom-[-200px] left-1/2 h-[300px] w-[400px] sm:h-[600px] sm:w-[800px] md:w-[1000px] md:h-[600px] -translate-x-1/2 rounded-full bg-gradient-to-br from-[#96588a]/20 via-[#96588a]/10 to-transparent blur-3xl" />
