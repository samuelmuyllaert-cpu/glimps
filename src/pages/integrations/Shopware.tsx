...
import shopwareLogo from "@/assets/shopware-logo-blue-rgb.png";
import {
  ShoppingCart,
...
const ShopwareIntegration = () => {
  const { language } = useLanguage();
  const isFR = language === 'fr';
  const isEN = language === 'en';

  const enContent = {
    badge: "Shopware Integration",
    title: "AI Chatbot for",
    titleHighlight: "Shopware",
    subtitle: "Connect Glimps to your Shopware store via a simple widget. Automatic synchronisation of products, stock and orders — for smart customer service 24/7.",
    ctaButton: "Request a demo",
    howTitle: "How the Shopware integration works",
    howSteps: [
      { step: "01", title: "Add the widget", desc: "Paste a simple snippet into your Shopware storefront. No plugin, no complex configuration." },
      { step: "02", title: "Automatic sync", desc: "All your products, categories, prices and stock are automatically imported via the Shopware API." },
      { step: "03", title: "AI training", desc: "The chatbot learns your catalogue, policies and brand voice within a few hours." },
      { step: "04", title: "Live and running", desc: "Your Shopware chatbot is live and answers customers 24/7." }
    ],
    benefitsTitle: "What Glimps does for your Shopware store",
    benefits: [
      ...
      { icon: RefreshCw, title: "Returns & exchanges", desc: "The chatbot guides customers through the return process in line with your Shopware policy." },
    ...
    useCases: [
      "\"Where is my Shopware order #12345?\"",
      "\"Do you have this model in black?\"",
      "\"What is your return policy?\"",
      "\"Recommend me a product for my home office\"",
      "\"How long does delivery take?\"",
      "\"Is this product in stock?\"",
      "\"Can I still change my delivery address?\"",
      "\"Are there any current promotions?\""
    ],
    statsTitle: "Average results for Shopware stores with Glimps",
    stats: [
    ...
    ctaTitle: "Ready to connect Glimps to Shopware?",
    ctaSubtitle: "Join innovative Shopware stores using Glimps to automate their customer service and sell more.",
    seoTitle: "AI Chatbot for Shopware - Glimps AI | Shopware Integration",
    seoDescription: "Connect Glimps to your Shopware store via a widget. Automatic product sync and order tracking. AI customer service 24/7 for your Shopware store.",
  };

  const content = isFR ? {
    badge: "Intégration Shopware",
    title: "Chatbot IA pour",
    titleHighlight: "Shopware",
    subtitle: "Connectez Glimps à votre boutique Shopware via un simple widget. Synchronisation automatique des produits, du stock et des commandes — pour un service client intelligent 24/7.",
    ctaButton: "Demander une démo",
    howTitle: "Comment fonctionne l'intégration Shopware",
    howSteps: [
      { step: "01", title: "Ajoutez le widget", desc: "Collez un simple extrait de code dans votre storefront Shopware. Aucun plugin, aucune configuration complexe." },
      { step: "02", title: "Synchronisation automatique", desc: "Tous vos produits, catégories, prix et stock sont importés automatiquement via l'API Shopware." },
      ...
      { step: "04", title: "En ligne et opérationnel", desc: "Votre chatbot Shopware est actif et répond aux clients 24h/24, 7j/7." }
    ],
    benefitsTitle: "Ce que Glimps fait pour votre boutique Shopware",
    benefits: [
      ...
      { icon: RefreshCw, title: "Gestion des retours & échanges", desc: "Le chatbot guide les clients dans les procédures de retour conformément à votre politique Shopware." },
    ...
    useCases: [
      "\"Où est ma commande Shopware #12345 ?\"",
      "\"Avez-vous ce modèle en noir ?\"",
      "\"Quelle est votre politique de retour ?\"",
      "\"Recommandez-moi un produit pour mon bureau à domicile\"",
      "\"Combien de temps prend la livraison ?\"",
      "\"Ce produit est-il en stock ?\"",
      "\"Puis-je modifier mon adresse de livraison ?\"",
      "\"Y a-t-il des promotions en cours ?\""
    ],
    statsTitle: "Résultats moyens pour les boutiques Shopware avec Glimps",
    stats: [
    ...
    ctaTitle: "Prêt à connecter Glimps à Shopware ?",
    ctaSubtitle: "Rejoignez des boutiques Shopware innovantes qui utilisent Glimps pour automatiser leur service client et augmenter leurs ventes.",
    seoTitle: "Chatbot IA pour Shopware - Glimps AI | Intégration Shopware",
    seoDescription: "Connectez Glimps à votre boutique Shopware via un widget. Synchronisation automatique des produits et commandes. Service client IA 24/7.",
  } : {
    badge: "Shopware Integratie",
    title: "AI Chatbot voor",
    titleHighlight: "Shopware",
    subtitle: "Verbind Glimps met je Shopware webshop via een eenvoudige widget. Automatische synchronisatie van producten, voorraad en bestellingen — voor slimme klantenservice 24/7.",
    ctaButton: "Demo aanvragen",
    howTitle: "Hoe de Shopware integratie werkt",
    howSteps: [
      { step: "01", title: "Voeg de widget toe", desc: "Plak een eenvoudig stukje code in je Shopware storefront. Geen plugin, geen complexe configuratie." },
      { step: "02", title: "Automatische synchronisatie", desc: "Al je producten, categorieën, prijzen en voorraad worden automatisch ingeladen via de Shopware API." },
      { step: "03", title: "AI training", desc: "De chatbot leert je catalogus, beleid en merkstijl binnen enkele uren." },
      { step: "04", title: "Live en operationeel", desc: "Je Shopware chatbot staat live en beantwoordt klanten 24/7." }
    ],
    benefitsTitle: "Wat Glimps doet voor jouw Shopware webshop",
    benefits: [
      ...
      { icon: RefreshCw, title: "Retour- en ruilbeheer", desc: "De chatbot begeleidt klanten door het retourproces conform jouw Shopware-beleid." },
    ...
    useCases: [
      "\"Waar is mijn Shopware bestelling #12345?\"",
      "\"Hebben jullie dit model in zwart?\"",
      "\"Wat is jullie retourbeleid?\"",
      "\"Aanbeveel me een product voor mijn thuiskantoor\"",
      "\"Hoe lang duurt de levering?\"",
      "\"Is dit product op voorraad?\"",
      "\"Kan ik mijn leveringsadres nog wijzigen?\"",
      "\"Zijn er momenteel acties?\""
    ],
    statsTitle: "Gemiddelde resultaten voor Shopware webshops met Glimps",
    stats: [
    ...
    ctaTitle: "Klaar om Glimps aan Shopware te koppelen?",
    ctaSubtitle: "Sluit je aan bij innovatieve Shopware webshops die Glimps gebruiken om hun klantenservice te automatiseren en meer te verkopen.",
    seoTitle: "AI Chatbot voor Shopware - Glimps AI | Shopware Integratie",
    seoDescription: "Verbind Glimps met je Shopware webshop via een widget. Automatische productsync en besteltracking. AI klantenservice 24/7.",
  };
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO title={activeContent.seoTitle} description={activeContent.seoDescription} path={isFR ? "/fr/integrations/shopware" : isEN ? "/en/integrations/shopware" : "/integrations/shopware"} language={language} />
      <StructuredData type="organization" />
      <StructuredData type="webpage" data={{ name: activeContent.seoTitle, description: activeContent.seoDescription, url: isFR ? "https://www.glimps.be/fr/integrations/shopware" : isEN ? "https://www.glimps.be/en/integrations/shopware" : "https://www.glimps.be/integrations/shopware" }} />
      <Navigation />

      <section className="relative overflow-hidden px-6 py-20">
        <div className="pointer-events-none absolute bottom-[-200px] left-1/2 h-[300px] w-[400px] sm:h-[600px] sm:w-[800px] md:w-[1000px] md:h-[600px] -translate-x-1/2 rounded-full bg-gradient-to-br from-[#189EFF]/20 via-[#189EFF]/10 to-transparent blur-3xl" />
        ...
        <div className="mx-auto max-w-4xl text-center">
          <div className="inline-flex items-center gap-3 rounded-2xl border border-border bg-card px-6 py-4 shadow-sm">
            <div className="flex h-10 w-10 items-center justify-center rounded-lg border border-border bg-white p-1.5">
              <img src={shopwareLogo} alt="Shopware" className="h-full w-full object-contain" />
            </div>
...
export default ShopwareIntegration;
