...
const KMStore = () => {
  ...
  const content = language === 'fr' ? {
    ...
    feature3Desc: "Nous traitons vos données avec attention pour la vie privée et la protection des données",
    ...
    feature3Desc: "We behandelen je gegevens met aandacht voor privacy en gegevensbescherming",
