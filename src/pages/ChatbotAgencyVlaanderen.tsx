...
const ChatbotAgencyVlaanderen = () => {
  ...
  return (
    <div className="min-h-screen bg-background" style={{ zoom: '0.8' }}>
      <SEO
        title="Chatbot Agency Vlaanderen E-commerce | Glimps - AI Experts voor Webshops"
        description="Glimps is jouw chatbot agency in Vlaanderen gespecialiseerd in e-commerce. Wij bouwen intelligente AI chatbots die verkopen verhogen en klanten 24/7 helpen. Experts in chatbot ontwikkeling voor webshops."
