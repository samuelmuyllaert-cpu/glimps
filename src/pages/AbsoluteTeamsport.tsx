...
const AbsoluteTeamsport = () => {
  ...
  const content = language === 'fr' ? {
    ...
    feature3Desc: "Nous traitons les conversations avec attention pour la vie privée et la protection des données",
    ...
    howItWorksDesc: "Cliquez sur le widget en bas à droite pour commencer",
    ...
    feature3Desc: "We behandelen gesprekken met aandacht voor privacy en gegevensbescherming",
    ...
    howItWorksDesc: "Klik op de widget rechtsonder om te beginnen",
