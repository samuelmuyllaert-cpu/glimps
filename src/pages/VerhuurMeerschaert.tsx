...
const VerhuurMeerschaert = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background via-background to-primary/5">
      ...
      <section className="container mx-auto px-4 py-12 sm:px-6 sm:py-16 md:py-20 lg:py-28">
        <div className="mx-auto max-w-4xl text-center">
          <div className="mb-4 sm:mb-6 inline-flex items-center justify-center">
            <div className="flex h-16 w-16 sm:h-20 sm:w-20 items-center justify-center rounded-2xl sm:rounded-3xl bg-gradient-to-br from-blue-500/20 to-indigo-500/20 shadow-lg">
      ...
      <section className="container mx-auto px-4 py-8 sm:px-6 sm:py-12 bg-gradient-to-b from-primary/5 to-background">
        <div className="mx-auto max-w-4xl">
          <div className="mb-6 sm:mb-8 text-center">
            <div className="mb-3 sm:mb-4 inline-flex h-12 w-12 sm:h-14 sm:w-14 items-center justify-center rounded-xl sm:rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-500 shadow-md">
          ...
          <div className="grid gap-4 sm:gap-6 md:grid-cols-3">
            <Card className="border-2 p-4 shadow-lg sm:p-6">
              <div className="mb-3 sm:mb-4 flex h-12 w-12 sm:h-14 sm:w-14 items-center justify-center rounded-xl sm:rounded-2xl bg-gradient-to-br from-blue-500 to-blue-600 shadow-md">
                <Sparkles className="h-6 w-6 sm:h-7 sm:w-7 text-white" />
              </div>
      ...
      <section className="container mx-auto px-4 py-12 sm:px-6 sm:py-16">
        <div className="mx-auto max-w-5xl">
          <div className="mb-8 sm:mb-12 text-center">
            <div className="mb-4 sm:mb-6 inline-flex h-12 w-12 sm:h-16 sm:w-16 items-center justify-center rounded-2xl sm:rounded-3xl bg-gradient-to-br from-blue-500 to-indigo-500 shadow-lg">
          ...
          <Card className="border-2 p-6 shadow-2xl sm:p-8 md:p-12">
            ...
            <div className="grid gap-4 sm:gap-6 md:grid-cols-2">
              <div className="flex items-start gap-4 rounded-lg bg-blue-50 p-4 transition-all hover:bg-blue-100">
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="flex justify-center">
            <div className="w-full max-w-[450px]">
              <iframe
                src="https://static.chatbotkit.com/integrations/widget/v2/YOUR_WIDGET_ID_HERE"
                width="100%"
                height="650"
                frameBorder="0"
      ...
      <section className="container mx-auto px-4 py-12 sm:px-6 sm:py-16">
        <div className="mx-auto max-w-4xl rounded-xl sm:rounded-2xl bg-gradient-to-br from-blue-50 to-indigo-50 p-6 text-center shadow-xl sm:p-8 md:p-12">
          <Sparkles className="mx-auto mb-4 sm:mb-6 h-12 w-12 sm:h-16 sm:w-16 text-blue-600" />
